...
import { CertificateCatalogs, SolicitudCertificado } from '@/modules/solicitud-certificado/domain/solicitud-certificado'

type Props = { solicitud: SolicitudCertificado; catalogs: CertificateCatalogs }
