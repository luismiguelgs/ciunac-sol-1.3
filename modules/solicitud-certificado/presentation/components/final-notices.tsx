...
import { CertificateText } from '@/modules/solicitud-certificado/domain/solicitud-certificado'

export default function FinalNotices({ texts }: { texts: CertificateText[] }) {
  return (
